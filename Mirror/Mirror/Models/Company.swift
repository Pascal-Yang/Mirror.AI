...
struct Companies {
    ...
    static let PayPal = Company(name: "PayPal", logo: "paypal_logo", description: "PayPal is a technology company that operates a digital payments platform allowing individuals and businesses to send and receive payments online securely.")
